    ...
    if (image === null) {
      ...
      try {
        const res = await dispatch(
          updateDataUser({ ...form, profilePicture: data.url })
        );
      } catch (error) {
        console.error(error);
      }
  ...
  return (
    <section className="editProfile">
      ...
      <form action="" className="editProfile__form" onSubmit={handleSubmit}>
        <section className="editProfile__image">
          {!img ? (
            <img
              ...
              alt=""
              className="editProfile__image--img"
            />
          ) : (
            <img src={img} alt="" className="editProfile__image--img" />
          )}
          <input
            type="file"
            className="editProfile__image--select"
            name="profilePicture"
            onChange={handleChangeImage}
          />
        </section>
        <section className="editProfile__info">
          <label htmlFor="name" className="editProfile__userData">
            {"Nombre: "}
            {currentDataUser.firstName}
          </label>
          <input
            type="text"
            className="editProfile__text"
            name="firstName"
            placeholder="Nombre"
        ...
        <button type="submit" className="editProfile__button">
          Actualizar{" "}
        </button>
      </form>
    </section>
